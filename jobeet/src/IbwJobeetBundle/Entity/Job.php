...
class Job
{
    ...
    /**
     * @var \IbwJobeetBundle\Entity\Category
     */
    private $category;
     ...
     * @return Job
     */
    public function setCategory(\IbwJobeetBundle\Entity\Category $category = null)
    {
    ...
    {
        if (!$this->getUpadtedAt()) {
            $this->upadted_at = new DateTime();
        }
    }
}
